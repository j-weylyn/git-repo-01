...
public class Pillow {
    ...
    /*     Constructor    */
    public Pillow(short width, short length, short height, short weight, String model, String type, String fabric, String fillingMaterial, boolean hasMoistureWicking) {
        this.width = width;
        this.length = length;
        this.height = height;
        this.weight = weight;
